    ...
    render()
    {
        return (
            <div style={{
                ...
                <p style={{color: '#fff', marginTop: '20px'}}>You can also find a printer friendly version of my CV <a href='./resume.html' target="_blank" rel="nofollow noopener noreferrer">here</a></p>
                <br/>
